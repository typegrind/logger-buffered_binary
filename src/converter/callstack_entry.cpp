...
callstack_entry::callstack_entry(typegrind::buffered_binary::log_entry const& entry, callstack_entry* parent, std::unordered_map<uint64_t, std::string> const& stringTable)
: id(++lastId)
